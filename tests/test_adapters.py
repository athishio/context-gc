...
from context_gc.middleware import call_anthropic_with_compaction, call_openai_with_compaction
...
def test_anthropic_adapter_live():
    ...
    context_gc.add_event({"id": "e1", "type": "set_var", "timestamp": 1000, "parent_id": None, "key": "x", "value": 10})
    context_gc.add_event({"id": "e2", "type": "set_var", "timestamp": 1010, "parent_id": "e1", "key": "x", "value": 20})
